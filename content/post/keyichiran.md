...
<div class="grid-item">ギルガメッシュ</div>
...
<div class="grid-item">光ファイバー</div>
...
<div class="grid-subtitle gty-2">BUILDINGCLASS_LIBRARY</div>
...
<div class="grid-subtitle gty-4">BUILDINGCLASS_COURTHOUSE</div>
...
<div class="grid-subtitle gty-2">BUILDINGCLASS_JAIL</div>
...
<div class="grid-subtitle gty-1">BUILDINGCLASS_HOSPITAL</div>
...
<div class="grid-item">BUILDINGCLASS_CONFUCIAN_MONASTERY</div>
...
<div class="grid-item">BUILDINGCLASS_PALACE</div>
...
<div class="grid-item">BUILDINGCLASS_ANGKOR_WAT</div>
...
<div class="grid-item">BUILDINGCLASS_CORPORATION_6</div>
...
<div class="grid-subtitle gty-1">UNITCLASS_LION</div>
...
<div class="grid-subtitle gty-1">UNITCLASS_EXECUTIVE_4</div>
...
<div class="grid-subtitle gty-4">UNITCLASS_SWORDSMAN</div>
...
<div class="grid-subtitle gty-1">UNITCLASS_GRENADIER</div>
...
<div class="grid-subtitle gty-3">UNITCLASS_CHARIOT</div>
...
<div class="grid-subtitle gty-1">UNITCLASS_MODERN_ARMOR</div>
...
<div class="grid-subtitle gty-2">UNITCLASS_GALLEON</div>
...
<div class="grid-subtitle gty-1">UNITCLASS_AIRSHIP</div>
...
<div class="grid-subtitle gty-1">UNITCLASS_GREAT_GENERAL</div>
...
<div class="grid-item">SPECIALUNIT_FIGHTER</div>
<div class="grid-item">戦闘機</div>
...
<div class="grid-item">UNITAI_CITY_DEFENSE</div>
...
<div class="grid-item">UNITAI_RESERVE_SEA</div>
...
<div class="grid-item">UNITAI_ATTACK_CITY_LEMMING</div>
...
<div class="grid-subtitle gty-5">CIVICOPTION_LABOR</div>
...
<div class="grid-item">TRAIT_PROTECTIVE</div>
...
<div class="grid-item">PROMOTION_CITY_GARRISON1</div>
...
<div class="grid-item">洋上プラットフォーム</div>
...
<div class="grid-item">BUILD_REMOVE_JUNGLE</div>
...
# 資源
<div class="grid-table gt2 auto-g">
<div class="grid-title">資源キー</div>
<div class="grid-title">資源</div>

<div class="grid-item">BONUS_ALUMINUM</div>
<div class="grid-item">アルミニウム</div>
<div class="grid-item">BONUS_COAL</div>
<div class="grid-item">石炭</div>
<div class="grid-item">BONUS_COPPER</div>
<div class="grid-item">銅</div>
<div class="grid-item">BONUS_HORSE</div>
<div class="grid-item">馬</div>
<div class="grid-item">BONUS_IRON</div>
<div class="grid-item">鉄</div>
<div class="grid-item">BONUS_MARBLE</div>
<div class="grid-item">大理石</div>
<div class="grid-item">BONUS_OIL</div>
<div class="grid-item">石油</div>
<div class="grid-item">BONUS_STONE</div>
<div class="grid-item">石材</div>
<div class="grid-item">BONUS_URANIUM</div>
<div class="grid-item">ウラン</div>
<div class="grid-item">BONUS_BANANA</div>
<div class="grid-item">バナナ</div>
<div class="grid-item">BONUS_CLAM</div>
<div class="grid-item">貝</div>
<div class="grid-item">BONUS_CORN</div>
<div class="grid-item">トウモロコシ</div>
<div class="grid-item">BONUS_COW</div>
<div class="grid-item">牛</div>
<div class="grid-item">BONUS_CRAB</div>
<div class="grid-item">蟹</div>
<div class="grid-item">BONUS_DEER</div>
<div class="grid-item">鹿</div>
<div class="grid-item">BONUS_FISH</div>
<div class="grid-item">魚</div>
<div class="grid-item">BONUS_PIG</div>
<div class="grid-item">豚</div>
<div class="grid-item">BONUS_RICE</div>
<div class="grid-item">米</div>
<div class="grid-item">BONUS_SHEEP</div>
<div class="grid-item">羊</div>
<div class="grid-item">BONUS_WHEAT</div>
<div class="grid-item">小麦</div>
<div class="grid-item">BONUS_DYE</div>
<div class="grid-item">染料</div>
<div class="grid-item">BONUS_FUR</div>
<div class="grid-item">毛皮</div>
<div class="grid-item">BONUS_GEMS</div>
<div class="grid-item">宝石</div>
<div class="grid-item">BONUS_GOLD</div>
<div class="grid-item">金</div>
<div class="grid-item">BONUS_INCENSE</div>
<div class="grid-item">香料</div>
<div class="grid-item">BONUS_IVORY</div>
<div class="grid-item">象牙</div>
<div class="grid-item">BONUS_SILK</div>
<div class="grid-item">絹</div>
<div class="grid-item">BONUS_SILVER</div>
<div class="grid-item">銀</div>
<div class="grid-item">BONUS_SPICES</div>
<div class="grid-item">香辛料</div>
<div class="grid-item">BONUS_SUGAR</div>
<div class="grid-item">砂糖</div>
<div class="grid-item">BONUS_WINE</div>
<div class="grid-item">ワイン</div>
<div class="grid-item">BONUS_WHALE</div>
<div class="grid-item">鯨</div>
<div class="grid-item">BONUS_DRAMA</div>
<div class="grid-item">ヒットミュージカル</div>
<div class="grid-item">BONUS_MUSIC</div>
<div class="grid-item">ヒット曲</div>
<div class="grid-item">BONUS_MOVIES</div>
<div class="grid-item">ヒット映画</div>
</div>


# 宗教
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">宗教キー</div>
<div class="grid-title">宗教</div>

<div class="grid-item">RELIGION_JUDAISM</div>
<div class="grid-item">ユダヤ教</div>
<div class="grid-item">RELIGION_CHRISTIANITY</div>
<div class="grid-item">キリスト教</div>
<div class="grid-item">RELIGION_ISLAM</div>
<div class="grid-item">イスラム教</div>
<div class="grid-item">RELIGION_HINDUISM</div>
<div class="grid-item">ヒンズー教</div>
<div class="grid-item">RELIGION_BUDDHISM</div>
<div class="grid-item">仏教</div>
<div class="grid-item">RELIGION_CONFUCIANISM</div>
<div class="grid-item">儒教</div>
<div class="grid-item">RELIGION_TAOISM</div>
<div class="grid-item">道教</div>
</div>

# 企業
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">企業キー</div>
<div class="grid-title">企業</div>

<div class="grid-item">CORPORATION_1</div>
<div class="grid-item">シリアル・ミル</div>
<div class="grid-item">CORPORATION_2</div>
<div class="grid-item">シド寿司</div>
<div class="grid-item">CORPORATION_3</div>
<div class="grid-item">スタンダード・エタノール</div>
<div class="grid-item">CORPORATION_4</div>
<div class="grid-item">クリエイティブ建設</div>
<div class="grid-item">CORPORATION_5</div>
<div class="grid-item">マイニング社</div>
<div class="grid-item">CORPORATION_6</div>
<div class="grid-item">アルミニウム社</div>
<div class="grid-item">CORPORATION_7</div>
<div class="grid-item">シヴィライズド・ジュエリー社</div>
</div>

# 外交態度
<div class="grid-table gt3 auto-g3">
<div class="grid-title">外交態度キー</div>
<div class="grid-title">外交態度</div>
<div class="grid-title">略語</div>

<div class="grid-item">ATTITUDE_FURIOUS</div>
<div class="grid-item">怒っている</div>
<div class="grid-item">激怒</div>

<div class="grid-item">ATTITUDE_ANNOYED</div>
<div class="grid-item">いらだっている</div>
<div class="grid-item">苛立</div>

<div class="grid-item">ATTITUDE_CAUTIOUS</div>
<div class="grid-item">用心している</div>
<div class="grid-item">警戒</div>

<div class="grid-item">ATTITUDE_PLEASED</div>
<div class="grid-item">不満はない</div>
<div class="grid-item">満足</div>

<div class="grid-item">ATTITUDE_FRIENDLY</div>
<div class="grid-item">親しみを感じている</div>
<div class="grid-item">友好</div>
</div>

# 風味
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">フレーバーキー</div>
<div class="grid-title">風味</div>

<div class="grid-item">FLAVOR_MILITARY</div>
<div class="grid-item">軍事</div>
<div class="grid-item">FLAVOR_RELIGION</div>
<div class="grid-item">宗教</div>
<div class="grid-item">FLAVOR_PRODUCTION</div>
<div class="grid-item">生産</div>
<div class="grid-item">FLAVOR_GOLD</div>
<div class="grid-item">経済</div>
<div class="grid-item">FLAVOR_SCIENCE</div>
<div class="grid-item">化学</div>
<div class="grid-item">FLAVOR_CULTURE</div>
<div class="grid-item">文化</div>
<div class="grid-item">FLAVOR_GROWTH</div>
<div class="grid-item">成長</div>
<div class="grid-item">FLAVOR_ESPIONAGE</div>
<div class="grid-item">諜報</div>
</div>

# 担当相
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">アドバイザーキー</div>
<div class="grid-title">担当相</div>

<div class="grid-item">ADVISOR_MILITARY</div>
<div class="grid-item">軍事</div>
<div class="grid-item">ADVISOR_RELIGION</div>
<div class="grid-item">宗教</div>
<div class="grid-item">ADVISOR_ECONOMY</div>
<div class="grid-item">経済</div>
<div class="grid-item">ADVISOR_SCIENCE</div>
<div class="grid-item">科学</div>
<div class="grid-item">ADVISOR_CULTURE</div>
<div class="grid-item">文化</div>
<div class="grid-item">ADVISOR_GROWTH</div>
<div class="grid-item">成長</div>
</div>

# 時代
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">時代キー</div>
<div class="grid-title">時代</div>

<div class="grid-item">ERA_ANCIENT</div>
<div class="grid-item">古代</div>
<div class="grid-item">ERA_CLASSICAL</div>
<div class="grid-item">古典時代</div>
<div class="grid-item">ERA_MEDIEVAL</div>
<div class="grid-item">中世</div>
<div class="grid-item">ERA_RENAISSANCE</div>
<div class="grid-item">ルネサンス時代</div>
<div class="grid-item">ERA_INDUSTRIAL</div>
<div class="grid-item">工業化時代</div>
<div class="grid-item">ERA_MODERN</div>
<div class="grid-item">現代</div>
<div class="grid-item">ERA_FUTURE</div>
<div class="grid-item">未来</div>
</div>

# 勝利条件
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">勝利条件キー</div>
<div class="grid-title">勝利条件</div>

<div class="grid-item">VICTORY_SCORE</div>
<div class="grid-item">スコア</div>
<div class="grid-item">VICTORY_TIME</div>
<div class="grid-item">時間</div>
<div class="grid-item">VICTORY_CONQUEST</div>
<div class="grid-item">征服</div>
<div class="grid-item">VICTORY_DOMINATION</div>
<div class="grid-item">制覇</div>
<div class="grid-item">VICTORY_CULTURAL</div>
<div class="grid-item">文化的</div>
<div class="grid-item">VICTORY_SPACE_RACE</div>
<div class="grid-item">宇宙開発競争</div>
<div class="grid-item">VICTORY_DIPLOMATIC</div>
<div class="grid-item">外交的</div>
</div>

# 部族集落
<div class="grid-table gt2-nw auto-g">
<div class="grid-title">部族集落タイプキー</div>
<div class="grid-title">イベント</div>

<div class="grid-item">GOODY_LOW_GOLD</div>
<div class="grid-item">ゴールド(少)</div>
<div class="grid-item">GOODY_HIGH_GOLD</div>
<div class="grid-item">ゴールド(多)</div>
<div class="grid-item">GOODY_MAP</div>
<div class="grid-item">地図</div>
<div class="grid-item">GOODY_SETTLER</div>
<div class="grid-item">開拓者</div>
<div class="grid-item">GOODY_WARRIOR</div>
<div class="grid-item">戦士</div>
<div class="grid-item">GOODY_SCOUT</div>
<div class="grid-item">斥候</div>
<div class="grid-item">GOODY_WORKER</div>
<div class="grid-item">労働者</div>
<div class="grid-item">GOODY_EXPERIENCE</div>
<div class="grid-item">経験値</div>
<div class="grid-item">GOODY_HEALING</div>
<div class="grid-item">回復</div>
<div class="grid-item">GOODY_TECH</div>
<div class="grid-item">技術</div>
<div class="grid-item">GOODY_BARBARIANS_WEAK</div>
<div class="grid-item">敵対(弱)</div>
<div class="grid-item">GOODY_BARBARIANS_STRONG</div>
<div class="grid-item">敵対(強)</div>
</div>
