...
[^1]: BtSでは、このように3つすべてを埋めてありますが、必ずしも3つすべてを埋める必要はありません。もちろん、減らすことができるだけで、最大値を超えることはできないことに注意してください。
...
### \<bAltDown\>
1を指定した場合、このユニットを生産するショートカットキーにAltキーを追加します。
...
### \<bShiftDown\>
1を指定した場合、このユニットを生産するショートカットキーにShiftキーを追加します。
...
### \<bCtrlDown\>
1を指定した場合、このユニットを生産するショートカットキーにCtrlキーを追加します。
